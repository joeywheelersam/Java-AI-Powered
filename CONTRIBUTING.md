...
2. Clone localmente: `git clone https://github.com/SEU_USERNAME/Java-AI-Powered.git`;
3. Adicione o remote upstream para manter seu repositório local atualizado: `git remote add upstream https://github.com/joeywheelersam/Java-AI-Powered.git`;
...
4. Crie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`:
    > Exemplo: `git checkout -b feat/community/joeywheelersam`
5. Dentro da pasta [`community`](https://github.com/joeywheelersam/Java-AI-Powered/tree/main/community), crie um arquivo em Markdown (extensão `.md`) e nomeie com o mesmo nome do seu usuário no GitHub;
    > Exemplo: `community/joeywheelersam.md` <br>
6. Desenvolva o seu perfil. Para isso, você pode ver exemplos na pasta [`community`](https://github.com/joeywheelersam/Java-AI-Powered/tree/main/community) e adicionar alguns dos utilitários presentes na pasta [`utils`](https://github.com/joeywheelersam/Java-AI-Powered/tree/main/utils);
...
10. Crie um **Pull Request**.
    > **Observação**: No geral, quando você der um push para o seu repositório do Github, ele perguntará para você se deseja fazer um Pull Request. Caso não apareça, é só você ir para o repositório, clicar em Pull Request e Create, e por último indicar o seu repositório e a branch em específico
