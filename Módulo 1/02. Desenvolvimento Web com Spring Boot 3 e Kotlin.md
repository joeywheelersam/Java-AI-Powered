...
<div align="left"> <!--About menu HTTP methods-->
    <table border="1">
        <tbody>
            <tr>
...
<p align="left">Aplicação refere-se a qualquer software com uma função distinta e Interface pode ser pensada como um contrato de serviço entre duas aplicações.</p>
