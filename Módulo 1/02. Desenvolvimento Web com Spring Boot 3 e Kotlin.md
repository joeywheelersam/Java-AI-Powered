...
<div>
    ...
    <p align="center"><img src="../img/07. Spring Framework.jpg" width="50%"></p>
    ...
    <p align="justify">Para facilitar a criação de aplicações utilizando outras IDEs o Spring disponibilizou o [Spring Initializr](https://start.spring.io/). Ele é uma UI que permite a criação de projetos Sprint Boot de forma facilitada.</p>
</div>
<br>
...
<div>
    ...
    <p align="center"><img src="../img/08. Arquitetura Projeto Spring.jpg" width="50%"></p>
    ...
    <p align="center"><img src="../img/09. Arquivo de Configuração.jpg" width="50%"></p>
</div>
<br>

## Referências <!--About references / Sobre referências-->
- [Slide da Aula](../docs/02.%20Desenvolvimento%20Web%20com%20Spring%20Boot%203%20e%20Kotlin.pptx)
