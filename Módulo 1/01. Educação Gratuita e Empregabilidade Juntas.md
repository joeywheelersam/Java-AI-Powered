...
flowchart LR;
    ...
    ACT --> Transição;
    Transição --- T([Apresentamos a Talent Math, uma solução exclusiva que ajuda as empresas parceiras a encontrar os talentos como você.]);
```
<br>
...
<div align="left">
    ...
    <table border="1">
        <tbody>
            <tr>
                <th rowspan="4"><img src="../img/01. matriz_eisenhower.jpg" width="75%;"></th>
